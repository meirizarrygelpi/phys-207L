...
\begin{enumerate}
    \item A table like Table \ref{table:08.results.elastic} with the results for the elastic collisions.
    \item A table like Table \ref{table:08.results.inelastic} with the results for the inelastic collisions.
    \item One chart with force in the vertical axis and time in the horizontal axis showing the time region where an \textbf{elastic} collision is happening.
    \item One chart with force in the vertical axis and time in the horizontal axis showing the time region where an \textbf{inelastic} collision is happening.
\end{enumerate}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.71]{image/08-impulse/Run12.png}
